!(function (e, n) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.ShapeLabelsFormatter = n())
    : ((e.Annotorious = e.Annotorious || {}),
      (e.Annotorious.ShapeLabelsFormatter = n()));
})(window, function () {
  return (function (e) {
    var n = {};
    function t(r) {
      ...
      function u(e, n) {
        for (var t = {}, r = [], o = 0; o < e.length; o++) {
          ...
          -1 !== f
            ...
            : i.push({ identifier: l, updater: m(d, n), references: 1 }),
            r.push(l);
        }
        return r;
      }
    ...
    function (e, n, t) {
      ...
      o()(a.a, i),
        ...
        (n.default = function (e) {
          return function (e) {
            var n = (Array.isArray(e.body) ? e.body : [e.body]).find(function (
              e
            ) {
